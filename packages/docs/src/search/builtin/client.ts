      ...
      .map(
        (r, i) => `
          <li
            ...
            class="border-l-2 border-transparent transition-colors aria-[selected=true]:border-blue-500 aria-[selected=true]:bg-blue-50 dark:aria-[selected=true]:bg-blue-950/40"
          >
