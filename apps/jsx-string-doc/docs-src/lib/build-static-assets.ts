...
export async function generateSecurityTxt(
  ...
  const lines = [
    ...
    "# --------",
    "",
    "Contact: https://github.com/cjean-fr/atelier/security/advisories/new",
    "Contact: mailto:christophe.jean@proton.me",
    "Preferred-Languages: en, fr",
    `Canonical: ${site}/.well-known/security.txt`,
    "Policy: https://github.com/cjean-fr/atelier/security/policy",
    "Encryption: https://github.com/cjean-fr/atelier/blob/main/SECURITY.md",
    "",
  ];
  await writeFile(
